...
public:
	...
	virtual inline void setNext( CellPart* const cp) noexcept{ runtime_assert(!next,"memory leak detected on virtual void CellPart::setNext(CellPart*) final",ERROR_CODE::LOGIC); next = cp;}
